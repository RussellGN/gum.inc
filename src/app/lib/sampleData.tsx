...
export const sampleNotifications: NotificationInterface[] = [
   ...
   },
   {
      ...
      user: sampleUsers[1],
      type: "account",
      content: "Find out how you can monetize your account on the monetization page",
      date: "2024-04-21",
      read: false,
   },
   {
      ...
      user: sampleUsers[1],
      type: "announcement",
      content: `Check out our new 'Gummy Pages' directory and consider becoming a member!`,
      date: "2024-04-02",
      read: true,
   },
   {
